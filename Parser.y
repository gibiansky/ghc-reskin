...
lastaexp :: { LHsExpr RdrName }
lastaexp : '\\' apat apats opt_asig '->' exp
...
fexp    :: { LHsExpr RdrName }
        : fexp2 lastaexp {% addReskinAnnotation ArgumentBlock (return (sLL $1 $> $ (HsApp $1 (noLoc (HsPar $2))))) }
        | fexp2 { $1 }

fexp2 :: { LHsExpr RdrName }
        : fexp2 aexp                             { sLL $1 $> $ HsApp $1 $2 }
        | 'static' aexp                         {% ams (sLL $1 $> $ HsStatic $2) [mj AnnStatic $1] }
        | aexp                                  { $1 }
